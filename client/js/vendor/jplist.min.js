    ...
    t.default = function e(t) {
      !(function (e, t) {
        ...
        t &&
          ...
          (this.type = (t.getAttribute('data-jplist-control') || '').trim().toLowerCase()),
      ...
      function t(e) {
        ...
        return (
          e &&
            ...
            (r.isInverted =
              'true' === (e.getAttribute('data-inverted') || '').toLowerCase().trim()),
        ...
        if (
          ...
          (this.panels = this.element.querySelectorAll('[data-type="panel"]')),
            (this.element.openedClass = (
              this.element.getAttribute('data-opened-class') || 'jplist-dd-opened'
            ).trim());
          let r = !0,
            n = !1,
            o = void 0;
                        ...
                        t.addEventListener('click', function (r) {
                          ...
                          try {
                            for (
                              ...
                              s.classList.toggle(t.element.openedClass),
                                s.classList.contains(t.element.openedClass) && (n = !0);
                            }
                          } catch (e) {
                            (i = !0), (a = e);
                          } finally {
                          ...
                          n
                            ...
                            : (t.classList.remove(t.element.openedClass),
                              t.element.classList.remove(t.element.openedClass));
                        });
                      },
          ...
          n(r, [
            {
              ...
              value: function (e) {
                ...
                if (
                  ((n.selected = 'true' === n.element.getAttribute('data-selected')),
        ...
        if (e) {
          ...
          for (let n = 1; n <= r.multipleSortsNumber; n++)
            (r['path' + n] = (e.getAttribute('data-path-' + n) || '').trim()),
              ...
              (r['dateTimeFormat' + n] = (e.getAttribute('data-date-format-' + n) || '')
                .trim()
                .toLowerCase());
        }
        return r;
      ...
      return (
        ...
        o(t, [
          ...
          },
          {
            ...
            value: function (e) {
              for (
                var t = !0, r = ['path', 'dataType', 'order', 'regex', 'dateTimeFormat'], n = 0;
                n < r.length;
                n++
              )
                t = t && this[r[n]] === e[r[n]];
              ...
              for (let o = 1; o <= this.multipleSortsNumber; o++)
                for (let i = 0; i < r.length; i++) t = t && this[r[i] + o] === e[r[i] + o];
              return t;
            },
          },
        ]),
                  ...
                  function (o) {
                    if (n && o.jplistState) {
                      ...
                      'dynamic' === e.mode &&
                        ...
                        (i = t.getDynamicCounterValue(n, e.filterType, o.jplistState.filtered)),
                        r.render(i);
                    }
                  },
                  !1
  ...
  function (e, t, r) {
    ...
    const l = (function (e) {
      function t(e, r) {
        ...
        return (
          (i.group = e), (i.name = r), (i.classNames = new Set()), (i.selectedClassName = ''), i
        );
      }
      return (
        (function (e, t) {
        ...
        o(
          ...
          [
            ...
            },
            {
              key: 'handleClasses',
              value: function () {
                const e = document.querySelectorAll('[data-jplist-group="' + this.group + '"]');
              ...
              value: function (e) {
                ...
                try {
                  for (
                    ...
                    const a = o.value;
                    a.groupClassName === e
                      ? ((a.selected = !0), a.element.classList.add('jplist-selected'))
                      : ((a.selected = !1), a.element.classList.remove('jplist-selected'));
                  }
                } catch (e) {
                  (r = !0), (n = e);
    ...
    const o = (function () {
      function e(t) {
        ...
        if (
          ...
          if (((this.element = t), this.element.classList.add('jplist-slider'), !this.element))
            return;
          (this.isVertical = r),
            (this.callback = l),
            (this.min = n),
          ...
          [
            ...
            },
            {
              ...
              value: function (e, t, r) {
                ...
                return (
                  ((e - 0) /
                    (this.element.getBoundingClientRect()[this.isVertical ? 'height' : 'width'] -
                      0)) *
                    (o - n) +
                  n
                );
            ...
            },
            {
              ...
              value: function (e) {
                ...
                this.isVertical
                  ? (this.dragging =
                      Math.abs(t.y - this.handler1.top) < Math.abs(t.y - this.handler2.top)
                        ? this.handler1
                        : this.handler2)
                  : (this.dragging =
                      Math.abs(t.x - this.handler1.left) < Math.abs(t.x - this.handler2.left)
                        ? this.handler1
                        : this.handler2),
                  this.render(e);
              },
              ...
              value: function (e, t) {
                ...
                if (t) {
                  ...
                  (this.range.style[o] = (l >= 0 ? l : 0) + 'px'),
                    this.callback && r && this.callback(this.handler1.value, this.handler2.value);
                }
              },
            },
            {
        ...
        n(t, [
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                let a = e.element.getAttribute('data-orientation') || 'horizontal',
                  l = !0,
                  u = !1,
                  s = void 0;
                try {
                ...
                n.slider = new i.default(o, 'vertical' === a, n.min, n.from, n.to, n.max, function (
                  e,
                  t
                ) {
                  let o = !0,
          ...
          },
          {
            ...
            value: function () {
              const e = this.controls
                .map(function (e) {
                  return e.id && e.slider && e.slider.handler1 && e.slider.handler2
                    ? e.id + '=' + e.slider.handler1.value + '_' + e.slider.handler2.value
                    : '';
                })
                .filter(function (e) {
                  return '' !== e;
            ...
            },
            {
              ...
              value: function () {
                return (
                  (this.id &&
                    this.selected &&
                    this.id + '=' + this.selected.element.getAttribute('data-value')) ||
                  ''
                );
              },
            },
      ...
      function t(e) {
        ...
        return (
          e &&
            ...
            (r.disabledClass = (e.getAttribute('data-disabled-class') || 'jplist-disabled').trim()),
            (r.selectedClass = (
        ...
        n(
          ...
          [
              ...
              value: function (e) {
                ...
                if (
                  ...
                  (r.itemsPerPageDD = Array.from(
                    r.element.querySelectorAll('[data-type="items-per-page-dd"]')
                  )),
                      ...
                      var l,
                        u = function () {
                          ...
                          (r.dropdown = new i.default(r)),
                            (r.buttons = Array.from(r.querySelectorAll('[data-value]')));
                          let n = !0,
                            o = !1,
                            a = void 0;
                          try {
                                ...
                                s = function () {
                                  ...
                                  n.addEventListener('click', function (o) {
                                    o.preventDefault(),
                                      ...
                                      t.setSelectedButton(),
                                      r.dropdown.close(),
                                      window.jplist && window.jplist.refresh(t.group, e);
                                  });
                                },
                      ...
                      var a,
                        l = function () {
                          ...
                          for (; n.pageButtonsHolder.firstChild; )
                            n.pageButtonsHolder.removeChild(n.pageButtonsHolder.firstChild);
                          for (
                            let o = function (e) {
                                const t = document.createElement('div');
                                t.innerHTML = n.btnTemplate
                                  .replace(new RegExp('{pageNumber}', 'g'), e + 1)
                                  .trim();
                                let o = t.firstChild,
                          ...
                          let O = Array.from(n.element.classList).filter(function (e) {
                              return (
                          ...
                          n.element.classList.add('jplist-pages-number-' + e.pagesNumber),
                            n.element.classList.add('jplist-items-number-' + e.itemsNumber);
                        },
            ...
            },
            {
              ...
              value: function (e, t, r) {
                e && e.preventDefault();
                const n = t ? t.getAttribute('data-page') : e.target.getAttribute('data-page');
        ...
        n(e, null, [
              ...
              if ('cookies' === r) {
                ...
                -1 === (o = Number(o) || -1)
                  ...
                  : (a.setMinutes(a.getMinutes() + o),
                    (document.cookie = name + '=' + i + ';path=/; expires=' + a.toUTCString()));
          ...
          },
          {
            ...
            value: function (t, r) {
              let n = '';
              if ('cookies' === t)
                for (let o = document.cookie.split(';'), i = 0; i < o.length; i++) {
          ...
          },
          {
            ...
            value: function (t) {
              const r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : '#',
                n = new Map();
              if (!t) return n;
              const o = window.decodeURIComponent(t.replace(r, '')).trim().toLowerCase();
              if (!o) return n;
              let i = o.split('&'),
                a = '',
                l = !0,
  ...
  function (e, t, r) {
    ...
    t.default = function e(t, r, n, o) {
      !(function (e, t) {
        ...
        (this.pagesNumber =
          0 === this.itemsPerPage ? 0 : Math.ceil(this.itemsNumber / this.itemsPerPage)),
      ...
      (this.rangeStart = this.currentPage - i),
        ...
        this.rangeStart <= 0 &&
          ((this.rangeStart = 0), (this.rangeEnd = Math.min(this.range - 1, this.pagesNumber - 1))),
        ...
        n(e, null, [
          ...
          },
          {
            ...
            value: function (t, r) {
              ...
              return (
                (i = i.trim())
                  ? ((c = e.getDateFromString(u, i)), (f = e.getDateFromString(s, i)))
                  : ((c = new Date(Date.parse(u))), (f = new Date(Date.parse(s)))),
                c.getTime() === f.getTime()
                  ? 0
                  : (o || (o = 'asc'),
                    'asc' === o
          ...
          },
          {
            ...
            value: function (t, r) {
              r = (r = (r = (r = (r = r.replace(/\./g, '\\.')).replace(/\(/g, '\\(')).replace(
                /\)/g,
                '\\)'
              )).replace(/\[/g, '\\[')).replace(/\]/g, '\\]');
        ...
        o(e, null, [
          {
            ...
            value: function (t, r, o) {
              const l = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : '',
                          ...
                          try {
                            for (
                              ...
                              if (w[D]) {
                                ...
                                for (const B in ((E = e.handleFilter(E, R.and, 'and', F.name)),
                                R.or))
              ...
              if (t && t.jump) {
                ...
                if ('top' === t.jump) r = 0;
                  ...
                  r < 0
                    ...
                    : o.top + window.pageYOffset - i < r && (r = o.top + window.pageYOffset - i);
                }
                ...
                for (var i, a = e[Symbol.iterator](); !(r = (i = a.next()).done); r = !0) {
                  ...
                  l.getSortOptions && (t.sortOptions = t.sortOptions.concat(l.getSortOptions())),
                    l.getTextFilterOptions &&
                      (t.textFilterOptions = t.textFilterOptions.concat(l.getTextFilterOptions())),
                    l.getPathFilterOptions &&
                      (t.pathFilterOptions = t.pathFilterOptions.concat(l.getPathFilterOptions())),
            ...
            value: function (e) {
              ...
              if (((r = '' === r ? t : t + r), window.location.hash !== r)) {
                let n = window.location.href.indexOf(t),
                  o = void 0;
                (o =
                  -1 === n ? window.location.href + r : window.location.href.substring(0, n) + r),
        ...
        o(e, [
          {
            ...
            value: function (e) {
              ...
              for (
                let t = [].concat(u(document.querySelectorAll('[data-jplist-item]'))), r = 0;
                r < t.length;
                r++
              )
                t[r].jplistIndex = r;
          ...
          },
          {
            ...
            value: function (e) {
              ...
              e && e(this.groups),
                ...
                (this.groups = i.default.findGroups(this.elements));
              for (
                let m = [].concat(u(document.querySelectorAll('[data-jplist-item]'))), g = 0;
                g < m.length;
                g++
              )
                m[g].jplistIndex = g;
